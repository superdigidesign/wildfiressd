(() => {
	...
	const displayCurrentTime = () => {
		...
		let dayText = ``;
		if(days[day].length === 6) dayText = `<span style="color: black;">ooo</span>${days[day]}`;
		if(days[day].length === 7) dayText = `<span style="color: black;">oo</span>${days[day]}`;
		if(days[day].length === 8) dayText = `<span style="color: black;">o</span>${days[day]}`;
		if(days[day].length === 9) dayText = `<span style="color: black;"></span>${days[day]}`;
		//formats mobile day
